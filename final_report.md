...
1. **Live ECS Fargate ENI IP at report time.** Resolved. Service is now torn down (Appendix C, verified 2026-05-29). Five historical IPs captured during the build session (`54.206.111.36`, `15.135.233.125`, `3.106.121.110`, `13.211.172.87`, `3.25.226.240`) are kept for archival only. The README "Live demo" banner now reflects the torn-down state with a one-command redeploy path.
